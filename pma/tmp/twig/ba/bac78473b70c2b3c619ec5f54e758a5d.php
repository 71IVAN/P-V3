...
class __TwigTemplate_5c99169196854857689e041cdd5d2cfb extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Status");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["status"]) {
            ...
            echo "\"";
            echo ((($context["status"] == twig_get_attribute($this->env, $this->source, ($context["event"] ?? null), "item_status", [], "any", false, false, false, 29))) ? (" selected") : (""));
            echo ">";
            echo twig_escape_filter($this->env, $context["status"], "html", null, true);
            echo "</option>
              ";
...
echo _gettext("Event type");
        ...
        if (($context["is_ajax"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["type"]) {
                ...
                echo "\"";
                echo ((($context["type"] == twig_get_attribute($this->env, $this->source, ($context["event"] ?? null), "item_type", [], "any", false, false, false, 40))) ? (" selected") : (""));
                echo ">";
                echo twig_escape_filter($this->env, $context["type"], "html", null, true);
                echo "</option>
                ";
        ...
        // line 52
        echo (((twig_get_attribute($this->env, $this->source, ($context["event"] ?? null), "item_type", [], "any", false, false, false, 52) != "ONE TIME")) ? (" hide") : (""));
        echo "\">
          <td>";
echo _gettext("Execute at");
        ...
        // line 58
        echo (((twig_get_attribute($this->env, $this->source, ($context["event"] ?? null), "item_type", [], "any", false, false, false, 58) != "RECURRING")) ? (" hide") : (""));
        echo "\">
          <td>";
echo _gettext("Execute every");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["interval"]) {
            ...
            echo "\"";
            echo ((($context["interval"] == twig_get_attribute($this->env, $this->source, ($context["event"] ?? null), "item_interval_field", [], "any", false, false, false, 64))) ? (" selected") : (""));
            echo ">";
            echo twig_escape_filter($this->env, $context["interval"], "html", null, true);
            echo "</option>
              ";
        ...
        <tr class=\"recurring_event_row";
        // line 69
        echo (((twig_get_attribute($this->env, $this->source, ($context["event"] ?? null), "item_type", [], "any", false, false, false, 69) != "RECURRING")) ? (" hide") : (""));
        echo "\">
          <td>";
echo _pgettext("Start of recurring event", "Start");
        ...
        <tr class=\"recurring_event_row";
        // line 75
        echo (((twig_get_attribute($this->env, $this->source, ($context["event"] ?? null), "item_type", [], "any", false, false, false, 75) != "RECURRING")) ? (" hide") : (""));
        echo "\">
          <td>";
...
";
    ...
    {
        return new Source("", "database/events/editor_form.twig", "/home/vagrant/proyectos/pma/templates/database/events/editor_form.twig");
    }
}
