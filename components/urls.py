...
urlpatterns = [
   # UI-ELEMENTS
    ...
    path('components-formwizard/',views.formSave.as_view(),name="forms-formSave"),
    path('formcontact',views.FormContact.as_view(),name="forms-formcontact"),
    path('formsavecontact',views.SaveContactForm.as_view(),name="forms-formSaveContact"),
