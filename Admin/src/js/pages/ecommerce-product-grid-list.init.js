            ...
            <div class="card ribbon-box ribbon-fill">\
                ...
                <div class="card-body pt-0">\
                    ...
                    <div class="mt-3 hstack gap-2">\
                        <a href="/apps/ecommerce/add-product" class="btn btn-primary w-100"><i class="ph-pencil me-1 align-middle"></i> Edit</a>\
                        <a href="/apps/ecommerce/products-details" class="btn btn-secondary w-100"><i class="ph-eye me-1 align-middle"></i> Overview</a>\
                    </div>\
                </div>\
            </div>\
        </div>';
