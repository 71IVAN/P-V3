...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function (element) {
        courseList.add({
            ...
            category: '<a href="/apps/learning/courses/grid-view" class="text-reset">' + element.category + '</a>',
    ...
    form.addEventListener('submit', function (event) {
        ...
        if (
            ...
            courseList.add({
                ...
                category: '<a href="/apps/learning/courses/grid-view" class="text-reset">' + categoryInput.value + '</a>',
                course_Name: '<div class="d-flex align-items-center gap-2">\
