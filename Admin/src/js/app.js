...
(function () {
	...
	function updateHorizontalMenus() {
		...
		Array.prototype.forEach.call(menuData, function (item, index) {
			...
			if (menusWidth + 100 > fullWidthOfMenu) {
