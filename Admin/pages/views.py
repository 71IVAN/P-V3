...
authentication_404_error = pagesview.as_view(template_name = "pages/authentication/auth-404.html")
authentication_500_error = pagesview.as_view(template_name = "pages/authentication/auth-500.html")
authentication_503_error = pagesview.as_view(template_name = "pages/authentication/auth-503.html")
...
pages_contacts= pagesview.as_view(template_name = "pages/pages-contacts.html")
